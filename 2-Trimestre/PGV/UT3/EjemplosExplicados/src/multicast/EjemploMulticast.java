...
public class EjemploMulticast {
	public static void main(String args[]) throws IOException {
		...
		//Se crea un objeto MulticastSocket para enviar mensajes.
		// Aquí no se asocia a ningún puerto específico porque solo se utiliza para envío, no para recepción.
