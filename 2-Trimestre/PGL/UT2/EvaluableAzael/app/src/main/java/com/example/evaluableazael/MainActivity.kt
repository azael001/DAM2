...
fun PantallaInsertar(){
    ...
    Column(
        ...
        Button(
            onClick = {
                val poke= Pokemons(numeroPokedex,nombre,tipo,vida.toInt())
    ...
    pokemon.get().addOnSuccessListener {
        for (docum in it){
            val pok = Pokemons(
                ...
                docum.data.get("vida").toString().toInt()
            )
...
data class Pokemons(val numeroPokedex: String, val nombre: String, val tipo: String, val vida: Int){
